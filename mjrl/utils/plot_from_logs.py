...
parser.add_argument('--data', '-d', type=str, required=True, help='location of the .pickle log data file') ## changed this to data folder!
parser.add_argument('--output', '-o', type=str, required=False, help='location to store results as a png') ## changhed to optional
...
if not args.output:
    OUT_FILE = args.data + '/plot.png'
elif '.png' in args.output:
    OUT_FILE = args.output
else:
    OUT_FILE = args.output + '/plot.png'
data = pickle.load(open(args.data + "/logs/log.pickle", 'rb'))
